# Do not move. Should be after sys.path..
"""
...
def analyze_individual(iid, ch=3, n_ref=503, save=True, save_fp=False,
                       path_mosaic="./Simulated/1000G_Mosaic/TSI/ch3_5cm/", exclude_pops=["TSI", ]):
...
def split_up_df_roh_gt(base_path="../Simulated/1000G_Mosaic/TSI/ch3_10cm/", n=20, ch=3):
...
def multi_run_individuals(n=20, ch=3, base_path="./Simulated/1000G_Mosaic/TSI/",
    ...
    for f in folders:
        for iid in iids:
            analyze_individual(iid=iid, path_mosaic=f, exclude_pops=["TSI", ])

        # Could do before for full parallelization
        split_up_df_roh_gt(base_path=f, n=n, ch=ch)
