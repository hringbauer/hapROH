...
### Produce C extension
In order to run the code, you need to build the C extension that implements the forward/backward pass. If you do not install hapROH via PIP or wish to prefer the development version, you can install it locally. You can do this via:
