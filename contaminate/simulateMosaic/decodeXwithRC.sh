...
python3 decodeXwithRC.py --cov $cov --con 0.05 --err 2e-2 --eref 1e-3
python3 decodeXwithRC.py --cov $cov --con 0.0 --err 2e-2 --eref 1e-3 
python3 decodeXwithRC.py --cov $cov --con 0.1 --err 2e-2 --eref 1e-3 