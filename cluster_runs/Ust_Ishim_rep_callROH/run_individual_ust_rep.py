...
if __name__ == "__main__":
    ...
    #base_path="./Data/SA_1240kHDF5/Ust_Ishim_rep/downsample_ph_r"
    iid, path_target = get_iid_path(i=run_nr, reps=50,
                                    base_path="./Data/SA_1240kHDF5/IPK12_rep/downsample_ph_r")
    ...
    hapsb_ind(iid=iid, chs=range(1, 23), 
              ...
              folder_out="./Empirical/1240k/SA_Readcounts/IPK12_rep/", prefix_out='', 
              e_model='haploid', p_model='MosaicHDF5', 
              post_model='Standard', processes=1, delete=True, output=True, save=True, 
